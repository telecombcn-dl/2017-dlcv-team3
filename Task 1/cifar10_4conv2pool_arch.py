...
model.add(Conv2D(32, (kernel_size, kernel_size), padding='same', activation='relu', input_shape=x_train.shape[1:]))
...
with open ('4conv2pool_noDA.txt','w') as f:
